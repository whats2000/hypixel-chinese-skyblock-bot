...
class VerifyDungeoneer(CodExtension):
    ...
    async def verifydung(self, ctx):
        ...
        if ctx.channel.id == get_setting_json('VerifyDungeoneerChannelId'):
            ...
            if get_setting_json('VerifyIdRole') in [y.name.lower() for y in ctx.message.author.roles]:
                ...
                print(f'Info > verify player dungeoneer : {ctx.message.author}')
                ...
                if player_data.api['success']:
                    ...
                    try:
                        ...
                        for profile_id in player_data.profile:
                            ...
                            try:
                                if is_class_level_get_success and is_dung_level_get_success:
                                    desc = f':trophy: 最高地下城等級 : {player_dung_max_level}' \
                                           f' \n\n===============\n\n:island: 島嶼職業等級 :\n\n'
                                    ...
                                    for dung in player_data.dung_level:
                                        ...
                                        desc = f'{desc} - {dung_list[dung]} : {player_data.get_dung_level(dung)}\n\n'
                        ...
                        try:
                            for i in range(10):
                                if i < 5:
                                    role = discord.utils.get(ctx.message.author.guild.roles, name=f'< {i}')
                            ...
                            if player_dung_max_level >= 100 or player_dung_max_level < 0:
                                ...
                                embed = discord.Embed(
                                    ...
                                    description=f'{ctx.message.author} -x-> Dungeoneer',
                                    color=0xe74c3c
                                )
